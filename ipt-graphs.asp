...
for (i = 0; i < 11; ++i) {
	...
	<tr><td>&nbsp;</td><td class="total">合计</a></td><td id="ccnt-total" class="total count"></td><td class="total pct">100%</td></tr>
	</table>
...
for (i = 0; i < 11; ++i) {
	...
	<tr><td>&nbsp;</td><td class="total">合计</a></td><td id="bcnt-total" class="total count"></td><td id="bcntx-total" class="total count"></td><td class="total pct">100%</td></tr>
	</table>
</td><td style="margin-right:150px">
<script type='text/javascript'>
if (nvram.web_svg != '0') {
...
for (i = 0; i < 11; ++i) {
	...
	<tr><td>&nbsp;</td><td class="total">合计</a></td><td id="obcnt-total" class="total count"></td><td id="obcntx-total" class="total count"></td><td class="total pct">100%</td></tr>
	</table>
</td><td style="margin-right:150px">
<script type='text/javascript'>
if (nvram.web_svg != '0') {
...
if (nvram.cstats_enable != '1') {
	W('<div class="note-disabled"><b>IP 流量监控已关闭.</b> &nbsp; <a href="admin-iptraffic.asp">启用&nbsp;&raquo;</a></div>');
}
</script>
