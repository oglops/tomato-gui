...
wmo = {'ap':'Access Point','apwds':'Access Point + WDS','sta':'无线客户端','wet':'无线桥接','wds':'WDS'};
...
wlg.setup = function() {
	...
	this.headerSet(['Interface', '启用', 'SSID', '工作模式', '桥接']);
...
<!-- LINUX24-BEGIN -->
<div class='section-title'>选项 <small><i><a href='javascript:toggleVisibility("options");'><span id='sesdivoptionsshowhide'>(点击此处显示)</span></a></i></small></div>
